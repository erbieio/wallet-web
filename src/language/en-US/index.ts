export default {
  wallet: {
    ...
    selectSNFT: "You have not selected any SNFTs",
    buySnft: "Do you have SNFTs? {link}",
    findMore: "Find More",
  ...
  bootstrapwindow: {
    ...
    welcome: "Welcome",
    wormHoles: "Erbie Wallet 1.0",
    wormHolesMessage: "Welcomed to Erbie. We’ve prepared some tips to get you started quickly.",
    wormHolesMessageEnd: "Congratulations on your start to a wonderful journey on Erbie!",
    accout: "Accout",
    accountMessage:
  ...
  introductorypage: {
    ...
    bootstrap3title:
      "Create your own NFT Staker with the click of a button",
    bootstrap4title:
  ...
  converSnft: {
    ...
    buy: "Buy SNFTs",
    tab1: "SNFT Redemption",
    tab3: "SNFT Staking",
    staking: "Staking period",
    iconmeTip: "This is the estimated annual profit you will get after SNFT staking",
    periodTip: "During this period,you will not be allowed redeeming your SNFT back"
  },
  common: {
    clearCanche:"Clear Cache",
    clearCancheSuccess:"Cache cleared successfully",
    ispoor: 'The balance is insufficient, please replenish the funds',
    days:"days",
    ...
    exchange_pledge:
      "You need to pledge a minimum of 700ERB to become a staker. you will have the opportunity to get block subsidy of blockchain.  ",
    no_data: "No Data",
    ...
    back: "Back",
    year: '/Year',
    aftertheexchangeisclosed: 'All data will be cleared after the staker is closed',
    yes: 'Yes',
    no: 'No',
    confirmthechanges: 'Confirm the changes',
    suretomodifytheexchangepledgeamountcustodyservicefee: 'Are you sure to modify the staker pledge amount/custody service fee?',
    suretocancel: 'Are you sure to cancel ?',
    breakGuide: "Are you sure to cancel the boot process ?",
    connect: "Connect to erbie",
    connect2: "Connect using erbie",
    ...
    snftColorTip: "SNFT grades are L0, L1, L2, and L3 from the lowest to the highest. You can synthesize it to higher levels for higher revenue. The rules are as below: 16 specific SNFT L0 synthesizes a unique SNFT L1, 16 specific SNFT L1 synthesizes a unique SNFT L2, and 16 specific SNFT L2 synthesizes a unique SNFT L3. The blue number indicates the SNFT L0 position number in an SNFT L1.  The green number indicates the position number of SNFT L1 in an SNFT L2.  The yellow number indicates the SNFT L2 position number in an SNFT L3, and the red number refers to the position number of an SNFT L3.",
    contrctTx: "Transaction of contract",
    contractAddr: "Address of contract",
    converTip:"Tips: After the SNFT exchange is successful, it will disappear from the wallet. You can view the exchange record in the wallet's transaction history or browser.",
    snftLabel:'Convert SNFTs ',
    hsitory: "Transaction history",
    viewInExchange:"Go to the staker",
  ...
  creatorSnft:{
		...
		totalWeight:"Current block height * SNFT value.",
  ...
  "castingnft": {
		...
		"royaltypopover": "Set up royalties for your NFT.",
  ...
  sidebar: {
    ...
    myexchange: 'Become a Staker',
    openexchange: 'Become a Staker',
    exchange: 'Open the Staker',
  ...
  generateNFT: {
    ...
    promptTit:"Prompts Word",
    aiPromptTit:"AI Prompts Word",
    promptWord:"Prompts Word / Image source URL",
    promptTip1:"By AI: Input the prompt or description you want to depict, select the AI mode, and pay a certain ERB fee. AI will create the NFT content specifically for you and send it to your email.",
    promptTip2:"By URL: Input the URL of the existing NFT content, which can be sourced from platforms like OpenSea that can read image information.",
    ...
    creativeMode:"AI Painting Mode",
    AIDrawing:"Enable AI drawing",
    AIDrawing2:"AI drawing",
    ...
    aiDrawTip:"After entering the AI prompts word and selecting this mode, AI will create an NFT for you. This requires a small ERB fee, with {money} ERB being the testing standard during the testnet phase.",
    emailTip:"The email will receive the AI NFT generated by ErbieChain for you."
  ...
  import: {
    ...
    announcement: 'The imported account is viewable in your wallet but cannot be retrieved through the Erbie secret recovery.',
  ...
  importsuccess: {
    ...
    check: 'You can now view your imported account at Erbie.',
    scanning: 'Scanning…'
  },
  sendto: {
    ...
    gasprice: "Gas Price",
    gastit:
      " Gas fees are paid to Erbie Validators who process transactions on the network. Erbie does not profit from gas fees. Gas fees are set by the network and fluctuate based on network traffic and transaction complexity.",
    missingassets:
      "Your account has insufficient assets. Please make sure there are sufficient assets available for transfer.",
    gasLimit: "Gas Limit",
    gasLimittit:
  ...
  loginwithpassword: {
    welcome: 'Welcome to Erbie wallet again',
    login: 'Log in',
    input: ' password ',
  ...
  importByMnemonic: {
    importfrommnemonic: 'Import from the Secret Recovery',
    import: 'import',
    mnemonic: 'Secret Recovery',
    password: 'new password',
    password2: 'confirm your password',
    input: 'Enter your secret recovery here',
    notmatch: 'Entered passwords differ',
    mnemonicExport: "Export Secret Recovery Phrase",
    backUpDesc: "Secret Recovery Backup, Export",
    unlock: "Please enter a password to unlock the secret recovery phrase",
    errorMonic: "Invalid secret recovery",
  ...
  mnemonic: {
    ...
    yourRecoveryPhraseTitle:
      "Under no circumstances will Erbie ask for your secret recovery phrase. Protect your funds and do not share your secret recovery phrase with anyone.",
    ...
    saveTips:
      "  Store your key in a secure Iocation. This is the only way to recover your wallet.Erbie does not keep a copy.",
    continue: "Continue",
    verifyMnemonicPhrase: "Verify Secret Recovery Phrase",
    protectYourFunds:
      "Protect your funds and do not share your secret recovery phrase with anyone.",
    correctOrder: "Tap each word in the corrrect order.",
    errorMessage: " Incorrect secret secret recovery phrase. please try again.",
    ...
    tryagain: 'Incorrect secret recovery phrase, please try again.',
    checkthemnemonic: 'Please check the secret recovery',
    backupyourQRcodeinasafeenvironment: 'Please back up your QR code in a safe environment Screenshot is not advised',
    tit2:"Verification secret recovery phrase"
  ...
  createwallet: {
    ...
    title: 'The password will be limited to unlocking your Erbie wallet on this device',
    password: 'new password',
    password2: 'confirm your password',
  ...
  createExchange: {
    ...
    name: 'Name',
    nameplaceholder: 'Staker name',
    namemessage: 'Please enter the Staker name',
    namemessagelength: 'The length of the staker name needs to be more than 4 characters',
    amount: 'Amount',
    close: 'Close',
    cancel: 'Cancel',
    confirm: 'Confirm',
    ...
    open_exchange: 'Open the Staker',
    openyourself: 'You also need to open the staker yourself',
    gohome: 'Go Home',
    ...
    dialogTextExchange: 'Open the Staker',
    create_approve: "You can also view the details of the request through the transaction history.",
    create_waiting: "You has been successfully staked!",
    create_success: "You will receive SNFT rewards.",
    ...
    commission: "This is the {value}% fee your staker will charge sellers who transact on your staker.",
    ...
    addTips: "Sorry, you need to wait one day to redeem your stake.",
    redemption: "Redemption",
    snft: "SNFT",
    desc1: "You can stake your SNFTs to have a chance to get rewards when a new block is created.",
    desc2: "Click this button to redeem your staked SNFTs.",
    exchange: "Staker",
    exchangeDesc: "Buy, sell, mint",
    console: "Console",
    consoleDesc: "Staker Management",
    staking: "Staking & Redemption",
    stakingDesc: "Add stake or redeem your stake",
    server: "Server",
    serverDesc: "{days} Days / {hours} Hours",
    pageTip: "This is the Staker management page.If you want to go to Staker's page ,click on \"Exchange\".If you want to he exchange's console,click on \"console\".If you want to add the stake amount or redeem your staking,click on \"Staking & Redemption\".If you want to change the setting of server,Click on \"Server\".",
    ...
    convert: "Convert",
    desc3: "This the button that you can convert your SNFT to ERB with Erbie Blockchain.",
  ...
  createAccountpage: {
    ...
    userAgreement:
      "I have read and accept Erbie the Terms of Service",
    ...
    yinsi: "I have read and accept Erbie the Terms of Service",
    ...
    back: 'Back',
    next: "Next",
    serviceandPrivacyNotice: 'Please review the Erbie ERB Wallet Terms of Service and Privacy Notice.',
    memErr: "The secret recovery format is wrong, please confirm and resubmit",
    ...
    pwdTip: "By proceeding, you agree to Erbie's {br} {link1} & {link2}",
    link1: "Terms Of Service",
    link2: "Privacy Notice.",
    pwdTip2: "By proceeding, you agree to Erbie's {br} {link1}",
  ...
  minerspledge: {
    ...
    gotIt: "Got it >",
    resetBtnTip: "With this button，you can recover your credibility to 70 credibility will cost {value} ERB. The ERB cost will be burnt by Erbie block chain.",
    ...
    stackFee: "Pledge fee",
    tip7: "The threshold value means the maxium amount of ERB you can redeem while you can still be the staker. If you enter the amount bigger than this amount, you will redeem all of your ERB.",
  ...
  setting: {
    ...
    safety: 'Export Private Key',
    safetytltle: 'Privacy Settings, Text & QR Code',
    networks: 'Networks',
    networkstltle: 'Add, Edit, Remove',
    currencyConversion: "Currency Conversion",
    languageSelection: "Language Selection",
    langTit: "Language",
    securityandPrivacy: "Export Private Key",
    ...
    aboutWormHoles: "About Erbie",
    wormHolesIntroduction: "Erbie Introduction",
  ...
  restWallet: {
    ...
    withyour: 'with your',
    secretRecoveryPhrase: 'Backup memorizing words',
  ...
  receiveRewards: {
    title: "Get Rewards",
    snfttit: "Receive SNFT",
    snfttext: "Reward {num} SNFT",
    exchangetit: "Gift Exchange",
    exchangetext: "Receive {num} pledge money",
    erbtit: "Get ERBs",
    erbtext: "ERB for {num}",
    toReceive: "To Receive",
    tiptit1: "Receive SNFT:",
    tiptit2: "Gift Exchange:",
    tiptit3: "Get ERBs:",
    tip1: "SNFTs obtained during the official Erbie event will be displayed on this page. You can click the “claim” button to get all the SNFTs in one click, and the SNFTs will be deposited directly into your current wallet.{br}You can operate your right and interests through the NFT trading centre in the lower right corner.",
    tip2: "If your current account does not have an opened exchange on Erbie, we will create one for you. Once it opens, you need to deploy your Exchange by following our tutorial. Also, you can choose our service to guide you to complete the Exchange deployment in the wallet. {br}If your account is not yet traded on Erbie, we will automatically increase the deposit amount accordingly.",
    tip3: "We will display the ERBs you received during the official Erbie campaign on this page. Please click the “Claim” button to get all the ERBs in one click, and the ERBs will be deposited directly into your current wallet.",
    ...
    confirm: "Confirm",
    snftext: "Reward {num} SNFT",
    addrTit: "Erbie wallet address:",
  ...
  contacts: {
    ...
    newadd: "New Add",
    tab_contacts: "My accounts",
    tab_recents: "Recent accounts",
    tab_rolodex: "Rolodex",
    hint: 'Hint',
  ...
  bourse: {
    ...
    marketName: "Staker Name",
    marketCom: "Staker Commission",
    tip1: "Choose the name for your Staker.",
    tip2: "This is the % fee your staker will charge sellers who transact on your staker.",
    stakingFee: "Staking Fee",
    tip3: "This is the amount of ERB you will stake to become a staker and receive staking regards; stake more to have a higher chance of getting rewards.",
    marketServer: "Staker Server",
    tip4: "This service will automate the staker hosting service, allowing you to get your staker online immediately!",
    totalAmount: "Total Amount ",
    gasFee: "Gas Fee",
    closeExchange: "Closing of the Exchange",
    name: "Name",
    tip5: " Choose the name for your Staker.",
    ...
    openSuccess: "Staked Succesfully!",
    wormExchange: "Erbie Exchange",
    wormConsole: "Erbie Exchange Console",
    ...
    tip12: "Cannot be changed",
    custom: "Custom",
    tip13: "If you do not use our service, after staking your ERB to open an  NFT Staker, you will need to follow the wiki instructions to set up your NFT Staker on your own server.",
    tip14: "After paying the 200 ERB server fee, your NFT Staker will go online immediately.",
    ...
    addServeAmount: "You can rent our server to host your staker for 200 ERB a year. Afer paying, your staker will be hosted on our server.",
    ...
    closeTip: "Sorry, you need to wait one day to redeem your stake.",
  ...
  guidePopup: {
    ...
    createExchangGuideTip2: "Staking, Redemption, and Staker Server",
  },
  // customExchangeModal
  customExchangeModal: {
