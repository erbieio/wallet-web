export default {
  ...
  generateNFT: {
    ...
    aiDrawTip:"After entering the AI prompts word and selecting this mode, AI will create an NFT for you. This requires a small ERB fee, with 10 ERB being the testing standard during the testnet phase.",
  ...
  createExchange: {
    ...
    addTips: "Sorry, you need to wait 365 days to redeem your stake.",
  ...
  bourse: {
    ...
    closeTip: "Sorry, you need to wait 365 days to redeem your stake.",
