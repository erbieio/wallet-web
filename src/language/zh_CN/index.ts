export default {
    ...
    bootstrapwindow: {
        ...
        identifier: "标识符",
        identifierMessage: "身份展示ID(验证者&质押者)",
        setUp: "设置",
        setUpMessage: "个人账户设置",
        network: "网络",
    ...
    wallet: {
        ...
        autoexchange: "成为质押者",
        autoNFTexchange: "一键创建NFT质押者",
        autoNFTExchangeSetting: "一键创建NFT质押者设置",
        settingsbar: "质押&服务器&关闭质押者",
        haveNoMoney: "请确保您的钱包里有足够的钱再重试！",
        access: '使用权',
        cmsandExchange: '内容管理系统&质押者',
        back: '返回',
        toBrowser: "在{link}上查看完整历史记录",
        scanLink: "区块浏览器",
        convertComplete: "转换完成",
        selectSNFT: "您还未选择任何SNFT",
        buySnft: "你有 SNFT 吗？ {link}",
        findMore: "寻找更多",
    ...
    converSnft: {
        ...
        tab3: "SNFT 质押",
        staking: "质押期",
        iconmeTip: "这是 SNFT 质押后您将获得的估计年度利润",
        periodTip: "在此期间，您将无法赎回您的 SNFT"
    ...
    common: {
        ...
        exchange_pledge:
            "您需要质押至少700ERB来开启您的质押者,在成功开启您的质押者后，您将有机会获得区块链的出块补贴，您的质押金额越高，被选中的概率也越高。",
        no_data: "无数据",
        mainNetwork: "主网",
        save: "保存",
        closed: "关闭",
        ...
        server: '服务器',
        year: '/年',
        aftertheexchangeisclosed: '质押者关闭后所有数据将被清除',
        yes: '同意',
        no: '拒绝',
        cancel: "取消",
        confirm: "确定",
        ...
        snftColorTip: "S-NFT等级从低到高分别为L0、L1、L2、L3。您可以合成更高等级以获取更高收益，合成规则如下：16个特定S-NFT L0可合成一个唯一S-NFT L1，16个特定S-NFT L1可合成一个唯一S-NFT L2，16个特定S-NFT L2可合成一个唯一S-NFT L3。蓝色数字表示在某一个S-NFT L1中，SNFT L0的位置编号。绿色数字表示在某一个S-NFT L2中，SNFT L1的位置编号。黄色数字表示在某一个S-NFT L3中，SNFT L2的位置编号。红色数字表示S-NFT L3的位置编号。",
        contrctTx: "合约交易",
        contractAddr: "合约地址",
        converTip:"提示: S-NFT交换成功后，将从钱包中消失。您可以在钱包的交易历史记录或浏览器中查看交易记录。",
        snftLabel:'S-NFTs转换',
        hsitory: "交易历史",
        viewInExchange:"去质押者查看",
    ...
    createExchange: {
        ...
        hi: '你好',
        anto_exchange: '自动 NFT 质押者',
        nomoney: '余额不足',
        name: '名称',
        nameplaceholder: '这个名称是质押者的',
        namemessage: '质押者名称',
        namemessagelength: '质押者名称长度需要4位以上',
        amount: '数额',
        close: '关闭',
        cancel: '取消',
        confirm: '确认',
        ...
        pageTip: "这是质押者管理页面。如果你想去质押者的页面，点击“质押者”。如果你想进入质押者的控制台，点击“控制台”。如果你想添加质押量或赎回你的质押，点击在“Staking & Redemption”。如果要更改服务器的设置，请单击“Server”。",
        ...
        convert: "转换",
        insufficientMoney:"在质押后，您的余额将低于201ERB，这不足以在我们的服务器上建立您的质押者。你需要支付额外的{value}ERB。"
    ...
    closeexchange: {
        closeexchange: '关闭质押者',
        lessthan: '你的质押者开设时长小于一年',
        shutitdown: '您确定要关闭它吗？您将获得 ${data} 承诺的退款。',
        successfully: '成功关闭质押者',
        minerspledge: '矿工质押',
    ...
    bourse: {
        ...
        stakingFee: "质押费",
        tip3: "这是您将质押的 ERB 数量以成为质押者并收到质押收益；质押更多以获得更高的奖励机会。 ",
        marketServer: "质押者服务器",
        ...
        period:"服务器剩余时间",
        periodAdd:"服务器时间追加",
        addServeAmount:"您可以租用我们的服务器进行质押者，每年需要支付200ERB。支付后，您就可以在我们的服务器上设置您的质押者。",
        minusStaking:"在您撤销700 ERB质押后，您将没有机会再次获得SNFT奖励。",
        tipname:"这是您的 NFT 质押者的名称。",
